...
2. Conta/projeto Firebase (Auth Email/Senha + Firestore em modo produção apenas após revisar as Rules).
3. Instalar Firebase CLI apenas se quiser publicar as Rules:
